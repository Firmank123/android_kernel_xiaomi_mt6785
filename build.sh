...
clone()
{
     ...
     then
          ...
          wget https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86/+archive/refs/heads/main/clang-r522817.tar.gz -O "aosp-clang.tar.gz"
          mkdir clang-llvm && tar -xf aosp-clang.tar.gz -C clang-llvm && rm -rf aosp-clang.tar.gz
          wget https://github.com/mvaisakh/gcc-build/releases/download/26102025/eva-gcc-arm-26102025.xz -O "gcc32.xz"
          mkdir gcc32 && tar -xf gcc32.xz -C gcc32 && rm -rf gcc32.xz
          wget https://github.com/mvaisakh/gcc-build/releases/download/26102025/eva-gcc-arm64-26102025.xz -O "gcc64.xz"
          mkdir gcc64 && tar -xf gcc64.xz -C gcc64 && rm -rf gcc64.xz
